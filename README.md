...
``` bash
curl -s https://raw.githubusercontent.com/AhmedMohamedEid/odoo13-docker-compose/main/run.sh | sudo bash -s odoo-one 10013 20013
```
...
``` bash
curl -s https://raw.githubusercontent.com/AhmedMohamedEid/odoo13-docker-compose/main/run.sh | sudo bash -s odoo-two 11013 21013
```
