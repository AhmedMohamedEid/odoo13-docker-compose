...
``` bash
curl -s https://raw.githubusercontent.com/odoodvlpr/odoo13-docker-compose/master/run.sh | sudo bash -s odoo-one 10013 20013
```
...
``` bash
curl -s https://raw.githubusercontent.com/odoodvlpr/odoo13-docker-compose/master/run.sh | sudo bash -s odoo-two 11013 21013
```
